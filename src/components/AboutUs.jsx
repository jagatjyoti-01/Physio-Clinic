        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed font-custom1 text-center">
              ...
              personalized, expert physiotherapy care to help you achieve
              optimal health and mobility. Our skilled team uses innovative
              techniques and compassionate care to guide you on your path to
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-8">
              ...
              >
                ...
                <h3 className="text-xl font-semibold font-custom">
                  Our Vision
                </h3>
                <p className="text-gray-600 font-custom1">
                  Leading physiotherapy care, enhancing lives with innovation
                  and compassion.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 font-custom1 ">
                  Empowering health through personalized treatments and
                  dedicated care.
                </p>
              </motion.div>
            </div>
            ...
            >
              More details{" "}
              <FaArrowRight className="ms-2 bg-slate-100 text-primary rounded-lg p-1" />
            </motion.button>
          </motion.div>
        </div>
      </div>
